...
export default {
  ...
  methods: {
    buyContract() {
      ...
      const contract = new web3.eth.Contract(this.erc20abi, this.erc20ContractAddress);
      contract.methods.approve('0x560c6067b94048F92Bd89e44D205c3597A4fe82E', web3.utils.toWei(this.finalValue)).send({ from: localStorage.getItem('account'), gas: 2000000, gasPrice: '20000000000' });
    },
